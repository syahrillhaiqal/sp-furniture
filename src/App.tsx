...
const MainAppLayout: React.FC = () => {
  ...
  return (
    <div className={isAdminRoute ? 'min-h-screen bg-stone-50 select-none' : 'min-h-screen bg-stone-50 select-none pb-12 flex flex-col justify-between'}>
      <div>
        {/* Core Store Navbar/Toolbar */}
        {!isAdminRoute && <Navbar />}

        {/* Dynamic transition view stage wrapped in AnimatePresence */}
        <main className={isAdminRoute ? '' : 'py-2'}>
